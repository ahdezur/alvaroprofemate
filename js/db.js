...
const DB = {
  ...
  _seedLocalCourses() {
    ...
    if (dbVersion === "200.0" && courses && courses.includes("introduccion-algebra") && chapters && chapters.includes("Lógica y Funciones Proposicionales")) {
      return;
    }
    ...
    localStorage.setItem("alvaro_profemate_db_version", "200.0");
