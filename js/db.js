...
const DB = {
  ...
  _seedLocalCourses() {
    ...
    if (dbVersion === "88.0" && courses && courses.includes("calculo-multivariable") && chapters && chapters.includes("Determinación de Dominio con Múltiples Restricciones")) {
      return;
    }
    ...
    localStorage.setItem("alvaro_profemate_db_version", "88.0");
