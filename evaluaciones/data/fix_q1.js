...
const contexto1a = `Respecto de la función<br>$$f(x,y)=\\begin{cases}\\displaystyle \\dfrac{x^2y}{x^2+y^2}, & (x,y)\\neq(0,0)\\\\[0.2cm]0, & (x,y)=(0,0)\\end{cases}$$`;

data.forEach(q => {
  if (q.id === 'p1-a-i-derivadas-parciales') {
    q.numeracion_personalizada = '1a-i';
    q.contexto = contexto1a;
    q.enunciado = "calcule, si existen, $\\displaystyle \\dfrac{\\partial f}{\\partial x}(x,y)$ y $\\displaystyle \\dfrac{\\partial f}{\\partial y}(x,y)$ para $(x,y)\\in\\mathbb R^2$.";
  }
