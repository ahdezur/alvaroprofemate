...
Dado
$$
z=e^{xy},\qquad x=2u+v,\qquad y=\frac{u}{v}
$$
determine $\frac{\partial z}{\partial u}$ y $\frac{\partial z}{\partial v}$ en términos de $u$ y $v$, en la forma más reducida posible.
...
&=(ye^{xy})(2)+(xe^{xy})\left(\frac{1}{v}\right)\\
&=\left(2y+\frac{x}{v}\right)e^{xy}\\
&=\left(\frac{2u}{v}+\frac{2u+v}{v}\right)e^{(2u+v)(u/v)}\\
&=\left(\frac{4u}{v}+1\right)e^{(2u+v)(u/v)}
\end{aligned}
$$
Asimismo,
$$
...
&=(ye^{xy})(1)+(xe^{xy})\left(-\frac{u}{v^2}\right)\\
&=\left(y-x\frac{u}{v^2}\right)e^{xy}\\
&=\left(\frac{u}{v}-(2u+v)\frac{u}{v^2}\right)e^{(2u+v)(u/v)}\\
&=-\frac{2u^2}{v^2}e^{(2u+v)(u/v)}
\end{aligned}
$$
\end{solucion}

\criterio{Plantea correctamente la regla de la cadena para $\frac{\partial z}{\partial u}$ y calcula las derivadas parciales involucradas.}{6}
\criterio{Sustituye $x=2u+v$ e $y=u/v$ y reduce correctamente la expresión de $\frac{\partial z}{\partial u}$.}{6}
\criterio{Plantea correctamente la regla de la cadena para $\frac{\partial z}{\partial v}$, incluyendo $\frac{\partial y}{\partial v}=-u/v^2$.}{6}
\criterio{Sustituye y simplifica correctamente hasta obtener $\frac{\partial z}{\partial v}=-\frac{2u^2}{v^2}e^{(2u+v)(u/v)}$.}{7}

\errorfrecuente{Derivar $e^{xy}$ respecto de $x$ o $y$ sin conservar el factor correspondiente: $y$ o $x$.}
\errorfrecuente{Calcular $\frac{\partial}{\partial v}(u/v)$ como $1/v$ en lugar de $-u/v^2$.}
...
$$
\int\!\!\int\!\!\int_E
\frac{e^{-x^2-y^2-z^2}}{\sqrt{x^2+y^2+z^2}}\,dV
$$
...
Además,
$$
\frac{e^{-x^2-y^2-z^2}}{\sqrt{x^2+y^2+z^2}}
=\frac{e^{-\rho^2}}{\rho}
$$
...
\frac{e^{-\rho^2}}{\rho}\rho^2\sin\varphi\,d\rho\,d\varphi\,d\theta\\
...
\begin{aligned}
\int_C\vec F\cdot d\vec r
&=\int\!\!\int_R\left(\frac{\partial}{\partial x}(x)-\frac{\partial}{\partial y}(y)\right)dA\\
&=\int\!\!\int_R0\,dA\\
&=0
\end{aligned}
$$
...
\criterio{Reconoce que $C$ es una curva cerrada, aplica correctamente el Teorema de Green y obtiene $\frac{\partial Q}{\partial x}-\frac{\partial P}{\partial y}=0$, concluyendo que la integral vale $0$.}{8}
