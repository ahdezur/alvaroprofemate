...
\begin{aplicacion}
  ...
  \begin{ejemplo}{Primeros términos de una sucesión}
    Consideremos la sucesión $a_n = \dfrac{n}{n+1}$. Los primeros cuatro términos son:
    \begin{itemize}
      \item $a_1 = \dfrac{1}{2} = 0.5$
      \item $a_2 = \dfrac{2}{3} \approx 0.67$
      \item $a_3 = \dfrac{3}{4} = 0.75$
      \item $a_4 = \dfrac{4}{5} = 0.8$
    \end{itemize}
  ...
  \begin{preguntaalternativas}{Tendencia de la sucesión}
    Enunciado de la pregunta de alternativas. ¿Hacia dónde tiende $a_n = \dfrac{1}{n}$?
  ...
  \begin{pareadosdoscolumnas}{Asociación de Sucesiones con su Límite}
    ...
    \columnaI{
      \item[1.] $a_n = \dfrac{1}{n}$
      \item[2.] $a_n = \dfrac{3n+2}{n}$
      \item[3.] $a_n = (-1)^n$
    }
    \columnaII{
      \item[A.] $L = 3$
